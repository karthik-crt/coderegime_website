                    ...
                    <div class="modal-form-grid">
                        ...
                        <div class="modal-form-group full-width" style="flex-direction: row; align-items: flex-start; gap: 10px;">
                            ...
                            <label for="modal-agree" style="font-weight: 500; font-size: 0.8rem; line-height: 1.4; cursor: pointer;">
                                I agree to the <a href="/privacy-policy.html" style="color: var(--modal-blue); text-decoration: none; font-weight: 700;">Privacy Policy</a> and <a href="/terms-of-service.html" style="color: var(--modal-blue); text-decoration: none; font-weight: 700;">Terms of Service</a>.
                            </label>
                        </div>
                    </div>
